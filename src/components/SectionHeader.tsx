export default function SectionHeader({
  ...
  return (
    <div className="mb-14">
      ...
      <h2 className="text-[clamp(24px,3.5vw,40px)] font-bold tracking-tight leading-tight text-t1 mb-3.5">
        {title}{" "}
        <span className="bg-linear-to-r from-a1 to-a2 bg-clip-text text-transparent">
          {highlight}
        </span>
      </h2>
      <p className="text-[clamp(14px,1.4vw,16px)] text-t2 font-light leading-relaxed max-w-145">
        {subtitle}
      </p>
    </div>
  );
