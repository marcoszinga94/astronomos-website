  ...
  return (
    <nav className="sticky top-0 z-50 bg-bg/85 backdrop-blur-2xl border-b border-white/5 h-15">
      <div className="max-w-[1120px] mx-auto px-10 max-md:px-5 h-full flex items-center justify-between gap-6">
        ...
        <a
          href="/inscripcion"
          className="text-13 font-semibold tracking-wider uppercase px-6 py-2 rounded-full bg-a1 text-white transition-all duration-200 hover:opacity-85 hover:-translate-y-0.5 shrink-0 max-lg:hidden"
        >
          Inscribirme
        </a>
      </div>
