    ...
    <footer className="border-t border-white/5 py-8">
      <div className="max-w-[1120px] mx-auto px-10 max-md:px-5">
        ...
        <div class="text-[12px] text-t2 text-center mt-6">
          Desarrollada por <a href="https://marcoszinga.vercel.app" target="_blank" rel="noopener noreferrer" class="text-a1 hover:text-white underline underline-offset-2 transition-colors">Marcos Zingaretti</a> y Alejandro Appendino con ❤️
        </div>
      </div>
    </footer>
  );
